...
alter table public.training_positions_catalog add column if not exists comments jsonb not null default '[]'::jsonb;
alter table public.training_positions_catalog add column if not exists source_text text not null default '';
alter table public.training_positions_catalog add column if not exists source_quality text not null default '';
...
alter table public.training_position_progress add column if not exists notes text not null default '';
alter table public.training_position_progress add column if not exists trained boolean not null default false;
alter table public.training_position_progress drop column if exists hits;
alter table public.training_position_progress drop column if exists misses;
alter table public.training_position_progress drop column if exists last_trained;
